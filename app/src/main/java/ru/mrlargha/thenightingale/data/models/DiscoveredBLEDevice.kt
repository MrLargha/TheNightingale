...
class DiscoveredBLEDevice : Parcelable {
    ...
    companion object {
        val CREATOR: Parcelable.Creator<DiscoveredBLEDevice?> =
            object : Parcelable.Creator<DiscoveredBLEDevice?> {
                override fun createFromParcel(source: Parcel): DiscoveredBLEDevice? {
                    return DiscoveredBLEDevice(source)
                }

                override fun newArray(size: Int): Array<DiscoveredBLEDevice?> {
